<aside id="sidebar-wrapper">
    <div class="sidebar-brand">
        <a href="index.html"> <img alt="image" src="{{ asset('template/assets/img/logo.png') }}"
    ...
    <ul class="sidebar-menu">
        ...
        <li class="dropdown {{ (\Request::is('class*')) ? 'active' : '' }}">
            <a href="{{ route('class.index') }}" class="nav-link"><i data-feather="calendar"></i><span>Aulas</span></a>
        </li>
        ...
        <li class="dropdown {{ (\Request::is('account/receivable*')) ? 'active' : '' }}">
            <a href="{{ route('receivable.index') }}" class="nav-link"><i data-feather="check-circle"></i><span>Contas a Receber</span></a>
        </li>
